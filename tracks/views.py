...
from core.utils import DEFAULT_PER_PAGE, MAX_PER_PAGE, build_page_links, paginate_queryset, parse_positive_int
...
def track_list(request):
    ...
    page_obj, pagination, page_notice = paginate_queryset(request, tracks)
    return render(
        request,
        "tracks/list.html",
        {
